		...
		<div class="container">
			<div class="footer__container">
				<div class="footer__item footer__item--category footer-category">
					<h2 class="footer-category__title">Каталог</h2>
				...
				<div class="footer__item footer__item--social footer-social">
					<h2 class="footer-social__title">Связаться с нами</h2>
					<p class="footer-social__subtitle">Контакты и адреса магазинов</p>
					<ul class="footer-social__list">
						<li class="footer-social__item">
							<a href="#" class="footer-social__link footer__link footer-social__link--vk">
				...
				<div class="footer__item footer__item--development footer-development">
					<ul class="footer-development__list">
						<li class="footer-development__item">Designer: <a href="#" class="footer__link">Anastasia Ilina</a> </li>
						<li class="footer-development__item">Developer: <a href="#" class="footer__link">Vladimir Mishchenko</a> </li>
					</ul>
				</div>
			</div>
		</div>
